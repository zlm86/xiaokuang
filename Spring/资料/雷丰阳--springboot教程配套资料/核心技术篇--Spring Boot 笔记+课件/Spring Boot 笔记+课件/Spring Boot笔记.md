...
| 日志门面  （日志的抽象层）                                   | 日志实现                                                     |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ~~JCL（Jakarta  Commons Logging）~~ 2014年停止更新   SLF4j（Simple  Logging Facade for Java）    **~~jboss-logging~~** | Log4j:存在性能问题  JUL（java.util.logging）  Log4j2  **Logback** |
